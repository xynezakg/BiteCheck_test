  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: colors.lightGray, fontFamily: modernFont, display: 'flex', flexDirection: 'column' }}>
      ...
      <style>{`
        ...
        /* Mobile Phones & Stacking Breakpoint */
        @media (max-width: 600px) {
          ...
          .univ-text { font-size: 15px !important; text-align: center !important; } 
          .staff-btn-container { 
            width: 100% !important; 
            display: flex !important; 
            justify-content: center !important; 
          }
          .staff-btn-container button {
            width: 100% !important;
            justify-content: center !important;
          ...
          .main-card { padding: 24px 16px !important; margin-top: -30px !important; }
